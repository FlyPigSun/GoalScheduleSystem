<template>
  <Teleport to="body">
    <div v-if="item" class="fixed top-0 left-0 w-full h-dvh z-50 flex items-end sm:items-center justify-center bg-black/30" @click.self="close">
      <div class="bg-white w-full sm:w-[480px] lg:w-[520px] rounded-t-2xl sm:rounded-2xl p-5 sm:p-6 lg:p-8 shadow-xl animate-slide-up max-h-[90dvh] overflow-y-auto">
        <!-- 编辑模式 -->
