<template>
  <div class="item-list">
    ...
    <Teleport to="body">
      <div v-if="detailItem" class="fixed top-0 left-0 w-full h-dvh z-50 flex items-end sm:items-center justify-center bg-black/30" @click.self="detailItem = null">
        <div class="bg-white w-full sm:w-[420px] rounded-t-2xl sm:rounded-2xl p-5 sm:p-6 shadow-xl animate-slide-up max-h-[85dvh] overflow-y-auto">
          <!-- 标题 - 可编辑 -->
          <div class="mb-1">
